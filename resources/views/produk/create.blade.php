        ...
        <div class="card-body">
          <form class="needs-validation" action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <select class="form-control" name="kodetoko">
                  ...
                  <option value="{{ $initoko -> kodetoko }}">{{ $initoko->kodetoko}} | {{ $initoko->nama}}</option>
                  @endforeach
                </select>
              </div>
            </div>
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <select class="form-control" name="kodekategori">
                  ...
                  <option value="{{ $inikategori -> kodekategori }}">{{ $inikategori->kodekategori}} | {{ $inibuku->keterangan}}</option>
                  @endforeach
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control" name="daerah" placeholder="Masukkan Daerah">
              </div>
            </div>
            <div class="form-group row mb-4">
