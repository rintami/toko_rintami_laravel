      ...
      <div class="card-body">
        <form class="needs-validation" action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <select class="form-control" name="kodetoko">
                  ...
                  <option value="{{ $initoko->kodetoko }}" @if($initoko->kodetoko == $initoko->kodetoko) selected @endif>{{ $initoko->nama}}</option>
                  @endforeach
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama" value="{{ $produk->nama }}">
              </div>
            </div>
            <div class="form-group row mb-4">
